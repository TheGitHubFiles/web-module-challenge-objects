...
console.log(createMenuItem('chili',6,'diner'));
/* Task 1b: use your function to create 3 more menu items. You may add any items to the menu that you'd like */
const pizza = createMenuItem('pep',12,'diner');
const cake = createMenuItem('cheese',8,'dessert');
const fries = createMenuItem('curly',3,'side');
...
const burgers = {name: "Burger", price: 18, category: "Lunch", discount: function(string){
...
console.log(burgers.discount('student'));
...
const b = {name:'Andrew', rating:1, feedback:'this sucks'};
 reviews.push({name:'Andrew', rating:1, feedback:'this sucks'});
